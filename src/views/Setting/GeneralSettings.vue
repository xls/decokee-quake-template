    ...
    <div style="height: 100%">
        ...
        <el-row :gutter="24" class="setting-item-row">
            ...
            <el-col :span="12">
                ...
                <el-button size="small" style="margin-left: 10px" @click="checkForUpdates"
                ...
                <el-col :span="12">
                    <el-radio-group v-model="monitorAppViewMethod" size="small" @change="handleMonitorAppViewMethodChanged">
                        <el-tooltip placement="top">
                            <template #content>
                                <span style="white-space: pre-wrap; line-height: 20px">
...
export default {
    ...
    methods: {
        ...
        enableStartOnBootChange(enable) {
            ...
            console.log('After start-on-boot change:', window.appManager.eventManager.getStartOnBoot());
        },
